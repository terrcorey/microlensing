...
from fit_2l1s import SHORT_NAME, chi2, guess, plot_fit
from mcmc_fit import save_corner

LABELS = ["t0", "u0", "tE", "alpha", "s", "q"]

T0_WIDTH = 20.0  # days around the PSPL joint fit's t0
U0_RANGE = (0.01, 1.0)
TE_RANGE = (10.0, 150.0)
S_RANGE = (0.7, 1.8)
...
def sample_prior(rng, n):
    ...
    return np.column_stack([t0, u0, tE, alpha, s, q])
